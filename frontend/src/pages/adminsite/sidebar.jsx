...
const SideBar = () => {
  return (
    <div>
      ...
      <div className="mt-6">
        <h6 className="text-blue-600 text-sm font-bold px-4">Product</h6>
        <ul className="mt-3">
          <li>
            <Link to="allProduct" href="javascript:void(0)"
              className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                viewBox="0 0 512 512">
                <path
      ...
      <div className="mt-6">
        <h6 className="text-blue-600 text-sm font-bold px-4">Category</h6>
        <ul className="mt-3">
          <li>
            <Link to="allCategory" href="javascript:void(0)"
              className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                viewBox="0 0 512 512">
                <path
          ...
          <li>
            <Link to="addCategory" href="javascript:void(0)"
              className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                viewBox="0 0 24 24">
                <path
      ...
      <div className="mt-6">
        <h6 className="text-blue-600 text-sm font-bold px-4">Contact</h6>
        <ul className="mt-3">
          <li>
            <Link to="allContact" href="javascript:void(0)"
              className="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-4"
                viewBox="0 0 512 512">
                <path
